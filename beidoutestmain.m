...
Nav_data = Nav_readerbeidou("D:\Third Year\ESSE 3670\Project 3\Data Downloaded\datasets to try with\algo\algo112008\brdm1180.21p"); %Use brdm1180.21p    %brdm1190.21p %brdm0840.21p  %brdm0840.21p  %brdm2260.20p  %brdm1180.21p  %brdm1560.20p  %brdm1180.21p"); %brdm1360.20p
%Nav_readerbeidou
Obs_data = testbeidouobsreader("D:\Third Year\ESSE 3670\Project 3\Data Downloaded\datasets to try with\algo\algo112008\0428SamsungS20Ultra_GnssLog.21o");  %Use CorrectSamsungS20Ultra_GnssLog0428.21o %Use SamsungS20Ultra_GnssLog0429.21o   % SamsungS20Ultra_GnssLog0429.21o  %SamsungS20Ultra_GnssLog0325.21o   %Pixel4XL_GnssLog0604.20o  %Mi8_GnssLog.20o  % %SamsungS20Ultra_GnssLog.21o  %Pixel4_GnssLog.21o     %Pixel4_GnssL.20o  Pixel4_GnssLog.21o"); %Pixel4_GnssLog.20o" %Pixel4_GnssLog.21o %39ea118x.21o
%testbeidouobsreader
...
earthrotation = 7.2921150e-5; %WGS84 value of the Earth's rotation rate
...
%         diffEktest = Ek - Ektest;
        ...
        Approxcoord = Approx'; 
        LLHtrans = EC2LLHB(VectorXYZ); %Calculating the latitude, longitude, and height of the ECEF coordinates
